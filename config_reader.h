...
// inih and ConfigReader are released under the New BSD license (see LICENSE.txt).
...
public:
    ...
    // Construct ConfigReader and parse given filename. See ini.h for more info
    // about the parsing.
    ConfigReader(std::string filename);

    // Construct ConfigReader and parse given file. See ini.h for more info
    // about the parsing.
